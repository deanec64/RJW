...
namespace rjw
{
	public class ABFCommon
	{
		...
		public static float would_fuck_ignoreSatisfy(Pawn fucker, Pawn p, bool invert_opinion = false)
		{
			...
			{
				bool flag2 = xxx.is_animal(fucker) && (long)ageBiologicalYears2 >= (long)((ulong)Mod_Settings.sex_free_for_all_age);
				bool flag3;
				if (flag2)
				{
					flag3 = true;
				...
				{
					bool flag4 = xxx.is_animal(p) && (long)ageBiologicalYears >= (long)((ulong)Mod_Settings.sex_free_for_all_age);
					if (flag4)
					{
						flag3 = true;
					}
					...
					{
						bool flag5 = (long)ageBiologicalYears >= (long)((ulong)Mod_Settings.sex_free_for_all_age) && (long)ageBiologicalYears2 >= (long)((ulong)Mod_Settings.sex_free_for_all_age);
						if (flag5)
						{
							flag3 = true;
						}
						...
						{
							bool flag6 = (long)ageBiologicalYears < (long)((ulong)Mod_Settings.sex_minimum_age) || (long)ageBiologicalYears2 < (long)((ulong)Mod_Settings.sex_minimum_age);
