...
namespace rjw
{
	public class ThinkNode_ChancePerHour_Beastiality : ThinkNode_ChancePerHour
	{
		...
		public override ThinkResult TryIssueJobPackage(Pawn pawn, JobIssueParams jobParams)
		{
			...
			{
				Logger.Message("[RJW]ThinkNode_ChancePerHour_Beastiality:TryIssueJobPackage - error message" + e.Message);
				Logger.Message("[RJW]ThinkNode_ChancePerHour_Beastiality:TryIssueJobPackage - error stacktrace" + e.StackTrace);
